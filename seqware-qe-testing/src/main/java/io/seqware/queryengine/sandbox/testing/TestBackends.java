...
public class TestBackends {
  ...
  /**
   * This tool assumes:
   * "java TestBackends settings.ini"
   * @param args 
   */
  public static void main(String[] args) {
    ...
    try {
      ...
      for (BackendTestInterface b : backends) {
        ...
        output.write(b.getIntrocutionDocs().getKv().get("docs"));
        ...
        // final docs
        output.write(b.getConclusionDocs().getKv().get("docs"));
  ...
  /**
   * TODO: this is where it should do heavy lifting of testing featureSet queries
   * using the getFeatures() method for each of the featureSets loaded in the backend.
   * You should do multiple JSON queries and these should cut across featureSets.
   * Work will need to be done to agree with the output format.
   * 
   * @param featureSets
   * @return 
   */
   ...
   * using the getReads() method for each of the readSets loaded in the backend.
   * You should do multiple JSON queries and these should cut across readSets.
   * Work will need to be done to agree with the output format.
   * 
   * @param featureSets
   * @return 
